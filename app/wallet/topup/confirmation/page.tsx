    ...
    <>
      ...
      <div className="flex flex-col md:flex-row w-full m-1 justify-self-center md:p-0 md:px-6 md:pt-12 max-w-[1400px] max-h-auto space-x-0 md:space-x-8 bg-color-layout">
        ...
        <div className="w-full p-2 md:p-0 max-h-auto">
          <h1 className="font-semibold text-color-primary text-[28px]">
            My Wallet
          </h1>
            ...
            <div className="flex flex-col gap-8 w-full h-full">
              <Card className="w-full">
                <CardHeader>
                  <div className="border-b pb-4 min-w-full">
                    <CardTitle className="text-md font-semibold text-color-primary">
              ...
              <Card className="w-full">
                <CardHeader className="flex flex-row items-center justify-between ">
                  <CardTitle className="text-md font-semibold text-color-primary border-b pb-4 min-w-full">
                    {paymentData.method}
                  </CardTitle>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-[24px] font-semibold text-color-secondary">
                      Rp{paymentData.totalAmount}
                    </p>
                  </div>

                  <div className="pt-4 text-center border-t pt-4 min-w-full">
              ...
              <Card>
                ...
                <CardContent className="space-y-6 py-6">
                  <p className="text-lg text-gray-600">
                    Silakan lakukan pembayaran segera agar proses sewa dalam
                    dilakukan
                  </p>
                  <Button
