      ...
      <header className='bg-navy-900 text-white py-4'>
        <div className='container mx-auto px-4 flex items-center justify-between'>
          <div className='flex items-center space-x-2'>
            <span className='font-bold text-xl'>PINTU SEWA</span>
            <span className='text-sm bg-white text-navy-900 px-2 py-0.5 rounded'>Seller</span>
          </div>
          ...
          <div className='flex items-center space-x-4'>
            <div className='relative'>
              <input
                type='text'
                placeholder='Cari barang pinjaman disewa...'
                className='pl-3 pr-10 py-1.5 rounded text-gray-800 w-64 focus:outline-none'
              />
            ...
            <div className='text-sm'>Perusahaha Studio</div>
          </div>
        </div>
      </header>
      ...
      <main className='container mx-auto py-6 px-4'>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className='flex justify-center'>
            <Button
              type='submit'
              className='bg-blue-800 hover:bg-blue-900 text-white px-8 py-2'
