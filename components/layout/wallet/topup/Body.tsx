  ...
  return (
    <Card className='px-2 md:px-6 mb-6'>
      <CardHeader className='px-0 border-b border-gray-200'>
        <h2 className='text-lg font-semibold text-color-primary'>Metode Topup</h2>
      </CardHeader>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-3'>
          {paymentMethods.map((method) => (
            <div
              ...
              className={`p-3 border rounded-lg cursor-pointer transition-all ${selectedMethod === method.id ? "border-blue-500 bg-blue-50" : "border-gray-200 hover:border-blue-300"}`}
            >
