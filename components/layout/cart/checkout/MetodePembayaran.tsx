...
const MetodePembayaranLayout = () => {
  return (
    <Card className="px-6 mb-[224px]">
      <CardHeader className="flex flex-col md:flex-row md:justify-between px-0">
      ...
      <CardContent className="flex flex-col md:flex-row md:space-x-12 lg:space-x-[147px]  p-0 pt-[18px] pb-7 border-t-[1px] border-t-[#D9D9D9]">
      ...
      <CardFooter className="p-0 pt-[18px] pb-7 border-t-[1px] border-t-[#D9D9D9] justify-end">
        <div className="flex-col max-w-[500px] w-full space-y-[14px]">
          ...
          <Button className="flex justify-self-end w-full max-w-[320px] xl:h-[54px] rounded-xl hover:opacity-80 bg-custom-gradient-tr">
