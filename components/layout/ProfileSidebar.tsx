              ...
              >
                <AccordionTrigger className='pl-5 pt-7 pr-5'>
                  <div className='flex space-x-2'>
                    <Image
                      ...
                      height={17.26}
                    />
                    <h4 className='text-color-primary text-xs lg:text-sm font-medium'>Akun Saya</h4>
                  </div>
                </AccordionTrigger>
                <AccordionContent className='w-full'>
                  <Link
                    ...
                    onClick={() => setIsMobileMenuOpen(false)}
                  >
                    <h4 className='pl-8 py-1.5 text-color-primary text-[10px] lg:text-[12px] font-medium hover:bg-color-third hover:text-color-primaryDark'>Edit Profile</h4>
                  </Link>
                  <Link
                    href={"/reset-password"}
                    onClick={() => setIsMobileMenuOpen(false)}
                  >
                    <h4 className='pl-8 py-1.5 text-color-primary text-[10px] lg:text-[12px] font-medium hover:bg-color-third hover:text-color-primaryDark'>Ubah Password</h4>
                  </Link>
                </AccordionContent>
                <Link
                  href={"/order-history"}
                  ...
                  <div className='pl-5 pr-2 pb-3'>
                    <div className='flex space-x-2'>
                      <Image
                        ...
                        height={20}
                      />
                      <h4 className='text-color-primary text-xs lg:text-sm font-medium group-hover:underline'>Pesanan Saya</h4>
                    </div>
                  </div>
                </Link>
                <Link
                  ...
                  <div className='pl-3.5 pr-2 pb-3'>
                    <div className='flex items-center space-x-1'>
                      <Image
                        ...
                        height={30}
                      />
                      <h4 className='text-color-primary text-xs lg:text-sm font-medium group-hover:underline'>Chat</h4>
                    </div>
                  </div>
                </Link>
                <Link
                  ...
                  <div className='pl-3.5 pr-2 pb-3'>
                    <div className='flex items-center space-x-1'>
                      <Image
                        ...
                        height={24}
                      />
                      <h4 className='text-color-primary text-xs lg:text-sm font-medium group-hover:underline'>Wallet</h4>
                    </div>
                  </div>
                </Link>
                <Link
