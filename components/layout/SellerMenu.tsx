...
const SellerMenu = ({ className }: SellerMenuProps) => {
  ...
  return (
    <>
      {overlay}
      <div className={cn(
        "fixed inset-y-0 left-0 z-40 w-64 transform bg-white transition-transform duration-300 md:static",
          ...
          <div className="space-y-1">
            ...
            >
              ...
              <CollapsibleContent className="pl-4 space-y-1">
                <Link href="/daftar-produk" legacyBehavior>
                  <a className={cn(
            ...
            <Button variant="ghost" size="sm" className="w-full justify-start gap-2 text-red-500 mt-4">
