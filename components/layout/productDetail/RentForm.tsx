  ...
  return (
    <div className="flex flex-col mt-[15px] md:mt-[60px] xl:max-w-[400px] xl:w-full pt-3 lg:pt-7 pb-4 xl:pb-[35px] px-3 xl:px-7 shadow-md outline-none bg-white">
      ...
      <div className="flex space-x-2 mt-[27px] items-center">
        ...
        <h4 className="text-xs xl:text-sm text-color-primary font-medium">Periode Sewa</h4>
      </div>
      <div className="flex mt-[14px] space-x-[6px] items-center">
        <div className="flex flex-col space-y-[6px]">
          <h4 className="text-[10px] xl:text-xs font-normal text-color-primary">Mulai</h4>
          <Popover>
        ...
        <div className="flex flex-col space-y-[6px]">
          <h4 className="text-[10px] xl:text-xs font-normal text-color-primary">Selesai</h4>
          <Popover>
            <PopoverTrigger asChild>
              <Button
      ...
      <div className="flex flex-col mt-[14px] space-y-[4px]">
            <div className="flex flex-col space-y-[6px]">
                <h2 className="text-[12px] xl:text-sm font-medium text-color-primary">Quantity</h2>
            ...
            <h3 className="text-[8px] xl:text-[10px] text-color-grayPrimary font-normal">Max. sewa 8 buah</h3>
      </div>
      <div className="flex mt-3 w-full pb-3 border-b-[1px] border-b-[#D9D9D9]">
        <TextedCheckbox>Co Renting</TextedCheckbox>
      </div>
      <div className="flex justify-between items-center w-full mt-3">
        <h3 className="text-normal text-color-primary text-[12px] xl:text-[14px]">Subtotal</h3>
        <h2 className="text-lg xl:text-[20px] text-color-primaryDark font-bold">Rp 500.000</h2>
      </div>
      <div className="flex flex-col mt-[14px] space-y-3">
            <Button className="w-full xl:h-[54px] hover:opacity-80 bg-custom-gradient-tr flex space-x-[9px]">
                <Image src={NextSymbol} alt="next-symbol" className="w-3 h-[14px] xl:w-5 xl:h-5"/>
            ...
            <Button className="w-full xl:h-[54px] bg-transparent border-[1px] border-color-primaryDark hover:bg-slate-200  flex space-x-[9px]">
                ...
                <h4 className="text-[12px] xl:text-lg font-medium text-color-primaryDark ">Keranjang</h4>
            </Button>
      </div>
    </div>
  );
