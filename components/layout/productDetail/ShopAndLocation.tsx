      ...
      <div className="flex justify-between border-y-[1px] border-[#D9D9D9]">
        <div className="flex space-x-3 py-[14px]">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex space-x-[6px] items-center">
              <Image src={Star} alt="star" className="w-[12px] h-[11px] lg:w-[15.4px] lg:h-[14px]" />
        ...
        <div className="flex flex-col pt-3 pl-5 space-y-2">
            ...
            <div className="flex space-x-[6px]">
                <Image src={Location} alt="truck" className="w-[14px] h-[10px] lg:w-[16px] lg:h-[16px]"/>
                <h4 className="text-[10px] lg:text-sm lg:font-medium text-color-primary">Dikirim dari <span className="font-bold">Jakarta Utara</span></h4>
            </div>
            <div className="flex space-x-[6px]">
                <Image src={Truck} alt="truck" className="w-[14px] h-[10px] lg:w-[16px] lg:h-[16px]"/>
                <h4 className="text-[10px] lg:text-sm lg:font-medium text-color-primary">Ongkir mulai Rp 50.000</h4>
            </div>
        </div>
    </div>
  );
