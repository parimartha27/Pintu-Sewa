  ...
  const validateForm = (): boolean => {
    ...
    const newErrors = {
      ...
      email: !email.trim()
        ...
        : "",
      jalan:
        addressType === "Alamat Baru" && !jalan.trim()
          ? "Jalan tidak boleh kosong"
          : "",
      provinsi:
        addressType === "Alamat Baru" && !selectedProvinsi
          ? "Provinsi harus dipilih"
          : "",
      kabupaten:
        addressType === "Alamat Baru" && !selectedKabupaten
          ? "Kabupaten harus dipilih"
          : "",
      kecamatan:
        addressType === "Alamat Baru" && !selectedKecamatan
          ? "Kecamatan harus dipilih"
          : "",
      kodePos:
        addressType === "Alamat Baru" && !selectedKodePos
          ? "Kode pos harus dipilih"
          : selectedKodePos &&
            !postCodeRegex.test(getTextById(selectedKodePos, kodePos))
              ...
              <CardContent className="px-0 pt-3 space-y-5">
                ...
                <Section Header="Alamat Toko">
                  <RadioGroup
                    ...
                    value={addressType}
                    onValueChange={(value: "Alamat Saat Ini" | "Alamat Baru") =>
