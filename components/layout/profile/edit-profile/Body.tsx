...
const EditProfileBody = () => {
  ...
  const { date, setDate, username, setUsername, fullname, setFullname, handphone, setHandphone, validateHandphone, gender, setGender } = useAuthForm()
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        const biodataRes = await axios.get<BiodataResponseProps>(`${customerBaseUrl}/${customerId}`)
