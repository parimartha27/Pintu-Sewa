          ...
          <div className='flex flex-col md:flex-row w-full md:space-x-5 mb-6'>
            <div className='flex flex-col mx-auto md:mx-0 w-1/2 lg:mr-12'>
              <Section
                ...
                className='text-center lg:text-start self-center md:self-start'
              >
                {loading ? <Skeleton className='h-4 w-36' /> : <h4 className='text-[12px] xl:text-[16px] font-semibold xl:font-medium text-color-primary'>{customerData?.street || "-"}</h4>}
              </Section>
              <Section
                title='Kabupaten / Kota'
                className='text-center lg:text-start self-center md:self-start'
              >
                {loading ? <Skeleton className='h-4 w-36' /> : <h4 className='text-[12px] xl:text-[16px] font-semibold xl:font-medium text-color-primary'>{customerData?.regency || "-"}</h4>}
              </Section>
              <Section
                title='Kode Pos'
                className='text-center lg:text-start self-center md:self-start'
              >
                {loading ? <Skeleton className='h-4 w-36' /> : <h4 className='text-[12px] xl:text-[16px] font-semibold xl:font-medium text-color-primary'>{customerData?.post_code || "-"}</h4>}
              </Section>
            </div>
            ...
            <div className='flex flex-col mx-auto md:mx-0 w-1/2 lg:mr-12'>
              <Section
                ...
                className='text-center lg:text-start self-center md:self-start'
              >
                {loading ? <Skeleton className='h-4 w-36' /> : <h4 className='text-[12px] xl:text-[16px] font-semibold xl:font-medium text-color-primary'>{customerData?.district || "-"}</h4>}
              </Section>
              <Section
                title='Provinsi'
                className='text-center lg:text-start self-center md:self-start'
              >
                {loading ? <Skeleton className='h-4 w-36' /> : <h4 className='text-[12px] xl:text-[16px] font-semibold xl:font-medium text-color-primary'>{customerData?.province || "-"}</h4>}
              </Section>
              <Section
                title='Catatan'
                className='text-center lg:text-start self-center md:self-start'
              >
                {loading ? <Skeleton className='h-4 w-36' /> : <h4 className='text-[12px] xl:text-[16px] font-semibold xl:font-medium text-color-primary'>{customerData?.notes || "-"}</h4>}
              </Section>
            </div>
          </div>
        </div>
