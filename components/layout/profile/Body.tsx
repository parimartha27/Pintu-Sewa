...
const ProfileBody = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <div className="flex flex-col  sm:flex-row w-full m-1 justify-self-center md:p-0 md:px-6 md:pt-12 max-w-[1400px] max-h-auto space-x-0 md:space-x-8">
      <div className="flex flex-col w-1/4 max-w-[60px] md:max-w-[280px] h-auto max-h-[190px] md:shadow-md ">
        <Button
          variant="ghost"
          onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)}
          className="md:hidden z-20 p-2 mx-auto hover:bg-color-third md:mx-8 w-full flex flex-col my-3 sm:py-10 group w-15 h-full"
        >
          <Image src={Profile} alt="menu" className="w-5 h-5" />
    ...
    <div className="flex flex-col space-y-8">
      <EditProfileForm title="Informasi Personal" iconName="Edit">
        <div className="w-full flex flex-col-reverse lg:flex-row justify-center items-center pb-3 xl:pb-0">
          <div className="flex flex-col md:flex-row w-full md:w-2/3 md:space-x-40">
