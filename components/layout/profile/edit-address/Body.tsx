    ...
    const loadProvinsi = async () => {
      try {
        ...
        if (data.status === 200) {
          ...
          setSelectedProvinsi(
            getIdByText(addressData.province || "", data.result) || data.result[0].id
          );
        }
      } catch (err) {
      ...
      try {
        ...
        if (data.status === 200) {
          ...
          setSelectedKabupaten(
            getIdByText(addressData.regency || "", data.result) || data.result[0].id
          );
        }
      } catch (err) {
      ...
      try {
        ...
        if (data.status === 200) {
          ...
          setSelectedKecamatan(
            getIdByText(addressData.district || "", data.result) || data.result[0].id
          );
        }
      } catch (err) {
    ...
    const loadKodePos = async () => {
      try {
        ...
        if (data.status === 200) {
          ...
          setSelectedKodePos(
            getIdByText(addressData.post_code || "", data.result) || data.result[0].id
          );
        } else {
          setKodePos([]);
          setSelectedKodePos("");
