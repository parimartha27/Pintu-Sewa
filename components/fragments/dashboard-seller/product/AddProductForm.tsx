...
export default function AddProductForm() {
  ...
  const onSubmit = async (data: Product) => {
    try {
      ...
      setAlertState({
        isOpen: true,
        message: "Gagal Menambahkan Produk: " + error,
        isWrong: true,
      });
    } finally {
    ...
    <main className="container">
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <Card className="p-6 mb-6">
          <h2 className="text-lg font-semibold mb-4 text-color-primary pb-4 border-b-[1px]">
            Informasi Produk
          </h2>
          ...
          <div className="mb-6">
            ...
            <div className="text-sm text-gray-500 mb-2">
              Nama produk maksimal 25 karakter. Dengan minimal jumlah produk,
              tips produk yang relevan produk
            </div>
            <Input
              id="name"
              className="w-full"
          ...
          <div>
            ...
            <div className="text-sm text-gray-500 mb-2">
              Pilih kategori yang sesuai dengan produk yang akan ditawarkan
            </div>
            <Controller
              name="category"
              control={control}
        ...
        <Card className="p-6 mb-6">
          ...
          <div className="mb-6">
            ...
            <div className="text-sm text-gray-500 mb-2">
              Masukkan foto yang sesuai dan menggambarkan produk yang akan
              disewakan
            </div>
            ...
            {uploadedImages.length === 0 && (
              <p className="text-red-500 text-sm">
                Minimal satu foto produk diperlukan
              </p>
            )}
          </div>
          ...
          <div className="mb-6">
            ...
            <div className="text-sm text-gray-500 mb-2">
              Tambahkan stok secara kasat Biar ketersediaan stok produk yang
              bisa untuk disewa
            </div>
            <Input
              id="stock"
            ...
            {errors.stock && (
              <p className="text-red-500 text-sm mt-1">
                Stok produk tidak boleh 0 atau kosong
              </p>
            )}
          </div>
          ...
          <div className="mb-6">
            ...
            <div className="text-sm text-gray-500 mb-2">
              Input ukuran dimensi produk yang akan disewakan
            </div>
          ...
          <div className="mb-6">
            ...
            <div className="text-sm text-gray-500 mb-2">
              Tulis harga produkmu yang sesuai.
            </div>
            <div className="flex items-center">
              <span className="bg-gray-100 px-3 py-2 border border-r-0 border-gray-300 rounded-l">
                Rp
              </span>
              <Input
                id="price"
            ...
            {errors.price && (
              <p className="text-red-500 text-sm mt-1">
                Harga produk tidak boleh 0 atau kosong
              </p>
            )}
          </div>
          ...
          <div>
            ...
            <div className="text-sm text-gray-500 mb-2">
              Tambahkan deskripsi produk dengan highlight keunggulan produk
              tersebut karena ini akan digunakan sebagai informasi kepada
              pembeli.
            </div>
            <Textarea
              id="description"
        ...
        <Card className="p-6 mb-6">
          ...
          <div className="text-sm text-gray-500 mb-2">
            Pilih jasa pengiriman yang sesuai dengan jenis produkmu
          </div>
          <Controller
        ...
        <Card className="p-6 mb-6">
          ...
          <div className="mb-6">
            ...
            <div className="text-sm text-gray-500 mb-2">
              Masukkan opsi durasi penyewaan dalam satuan waktu tertentu,
            ...
            <div className="flex flex-wrap gap-6 mt-4">
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    handleRentalChange("daily", checked === true)
                  }
                />
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    handleRentalChange("weekly", checked === true)
                  }
                />
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    handleRentalChange("monthly", checked === true)
                  }
                />
            ...
            {!rentalOptions.daily &&
              ...
              !rentalOptions.monthly && (
                <p className="text-red-500 text-sm mt-1">
                  Pilih minimal satu durasi penyewaan
                </p>
              )}
          </div>
          ...
          {rentalOptions.daily && (
            <div className="mb-6">
              <Label htmlFor="dailyPrice" className="font-medium">
                Harga Harian
              </Label>
              <div className="text-sm text-gray-500 mb-2">
                Tulis harga produkmu saat durasi sewa harian.
              </div>
              <div className="flex items-center">
                <span className="bg-gray-100 px-3 py-2 border border-r-0 border-gray-300 rounded-l">
                  Rp
              ...
              {errors.rentalOptions?.dailyPrice && (
                <p className="text-red-500 text-sm mt-1">
                  Harga harian tidak boleh 0 atau kosong
                </p>
              )}
            </div>
          )}
          ...
          {rentalOptions.weekly && (
            <div className="mb-6">
              <Label htmlFor="weeklyPrice" className="font-medium">
                Harga Mingguan
              </Label>
              <div className="text-sm text-gray-500 mb-2">
                Tulis harga produkmu saat durasi sewa mingguan.
              </div>
              <div className="flex items-center">
                <span className="bg-gray-100 px-3 py-2 border border-r-0 border-gray-300 rounded-l">
                  Rp
              ...
              {errors.rentalOptions?.weeklyPrice && (
                <p className="text-red-500 text-sm mt-1">
                  Harga mingguan tidak boleh 0 atau kosong
                </p>
              )}
            </div>
          )}
          ...
          {rentalOptions.monthly && (
            <div className="mb-6">
              <Label htmlFor="monthlyPrice" className="font-medium">
                Harga Bulanan
              </Label>
              <div className="text-sm text-gray-500 mb-2">
                Tulis harga produkmu saat durasi sewa bulanan.
              </div>
              <div className="flex items-center">
                <span className="bg-gray-100 px-3 py-2 border border-r-0 border-gray-300 rounded-l">
                  Rp
              ...
              {errors.rentalOptions?.monthlyPrice && (
                <p className="text-red-500 text-sm mt-1">
                  Harga bulanan tidak boleh 0 atau kosong
                </p>
              )}
            </div>
          )}
          ...
          <div>
            <div className="flex justify-between items-center mb-1">
              <Label htmlFor="minimumRentalDuration" className="font-medium">
                Jumlah Minimum Sewa
              </Label>
            </div>
            <div className="text-sm text-gray-500 mb-2">
              Masukkan jumlah minimum sewa produkmu
            </div>
            <Controller
        ...
        <Card className="p-6 mb-6">
          ...
          <div>
            <div className="flex justify-between items-center mb-1">
              <Label htmlFor="rentToBuy" className="font-medium">
                Rent to Buy
              </Label>
            </div>
            <div className="text-sm text-gray-500 mb-2">
              Rent to Buy adalah fitur unik pinjaman yang bisa digunakan oleh
              para seller.
            </div>
