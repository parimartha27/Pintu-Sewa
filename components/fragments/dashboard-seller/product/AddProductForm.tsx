          ...
          <div className='mb-6'>
            <div className='flex justify-between items-center mb-1'>
              <Label
                ...
                className='font-medium'
              >
                Nominal Deposit <span className='text-red-500'>*</span>
              </Label>
            </div>
            <div className='text-sm text-gray-500 mb-2'>Masukkan nominal deposit yang sesuai.</div>
            <div className='flex items-center'>
              <span className='bg-gray-100 px-3 py-2 border border-r-0 border-gray-300 rounded-l'>Rp</span>
              <Input
                id='deposit'
            ...
            {errors.price && <p className='text-red-500 text-sm mt-1'>Nominal deposit tidak boleh 0 atau kosong</p>}
          </div>
        </Card>
