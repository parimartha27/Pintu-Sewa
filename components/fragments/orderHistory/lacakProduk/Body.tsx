...
export default function TrackPackage() {
      ...
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          <p className="text-lg font-medium text-red-500">
            Error: {error || "No tracking data found"}
          </p>
  ...
  const currentStatus =
    trackingData.shipping_flow[trackingData.shipping_flow.length - 1]?.status;
      ...
      <div className="w-full">
        ...
        <Card className="mb-6">
          <CardHeader className="pb-2">
            <CardTitle className="text-xl font-semibold border-b border-color-[#D9D9D9] w-full pb-4 text-color-primary">
              Info Pengiriman
            </CardTitle>
          </CardHeader>
          <CardContent>
            <div className="flex flex-col space-y-4 py-4">
              <div className="flex justify-between">
                <h3 className="text-sm font-medium text-color-grayPrimary">
                  Opsi Pengiriman
                </h3>
                <p className="font-semibold text-color-primary text-base">
                  {trackingData.shipping_partner}
                </p>
              </div>
              <div className="flex justify-between">
                <h3 className="text-sm font-medium text-color-grayPrimary">
              ...
              <div className="flex justify-between">
                ...
                <div>
                  <p className="font-semibold text-color-primary text-base text-right">
                    {trackingData.customer_name}
                  </p>
                  <p className="text-sm text-color-grayPrimary whitespace-pre-line">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <div className="flex flex-col md:flex-row md:justify-between mb-1">
                        <div className="text-sm text-color-grayPrimary">
                          {event.process_date}
                        </div>
                        <div className="font-medium">{event.detail}</div>
                      </div>
                      <div className="text-sm text-color-grayPrimary">
                        Kurir: {event.shipping_man}
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div className="mt-6">
          <Alert className="bg-blue-50 border-blue-200">
            <div className="flex items-center gap-2">
              ...
              <div className="font-medium text-color-secondary">
                Status: {currentStatus}
              </div>
            </div>
            <AlertDescription className="mt-2 text-color-secondary">
              Paket Anda sedang dalam perjalanan dan akan diterima sesuai
              estimasi.
            </AlertDescription>
          </Alert>
        </div>
