  ...
  return (
    <div className='flex flex-col w-full lg:pl-8'>
      <div className='flex w-full justify-between'>
        <h2 className='text-lg xl:text-2xl text-color-primary font-semibold hidden lg:block'>Ulasan Penyewa</h2>
        <h2 className='text-lg text-color-primary font-semibold lg:hidden'>Ulasan Penyewa</h2>
        ...
        <Sheet>
          ...
          <SheetContent>
            <SheetHeader>
              <SheetTitle className='text-start text-lg text-color-primary font-semibold'>Filter Ulasan</SheetTitle>
            </SheetHeader>
            <CommentFilterBody />
          </SheetContent>
        </Sheet>
            ...
            {shopReview.map((review, index) => (
              ...
              >
                <div className='flex flex-col items-center lg:items-start min-w-[250px] space-y-3 px-6 border-r-[1px] border-[#D9D9D9] border-opacity-55'>
                  ...
                  <h2 className='font-semibold text-sm lg:text-base text-color-primary'>{review.product_name || "Nama Produk"}</h2>
                </div>
                <div className='flex flex-col space-y-1 pl-[34px] pr-6'>
                  <div className='flex space-x-3 mt-4 lg:mt-0'>
                    ...
                    <div className='flex flex-col'>
                      <h2 className='text-[12px] lg:text-[16px] text-color-primary font-medium lg:font-semibold'>{review.username || "Nama Pengguna"}</h2>
                      <div className='flex space-x-2'>
                        ...
                        <h3 className='text-[10px] lg:text-xs text-color-primary lg:mt-1'>{review.created_at || "x tahun yang lalu"}</h3>
                      </div>
                    </div>
                  </div>

                  <h4 className='w-full text-start text-color-primary text-[10px] lg:text-sm py-2 max-w-[800px]'>{review.comment || "Komentar Pengguna"}</h4>
